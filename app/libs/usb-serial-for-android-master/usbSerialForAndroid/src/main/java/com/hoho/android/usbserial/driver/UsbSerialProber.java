...
public class UsbSerialProber {
    ...
    /**
     * Probes a single device_filter for a compatible driver.
     * 
     * @param usbDevice the usb device_filter to probe
     * @return a new {@link UsbSerialDriver} compatible with this device_filter, or
